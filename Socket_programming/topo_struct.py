...
class SingleSwitchTopo(Topo):
	...
	def build(self):
		...
		self.addLink(s[0],h[1]) # s1 to h2
		self.addLink(s[1],h[3]) # s2 to h4
		self.addLink(s[2],h[0]) # s3 to h1
		self.addLink(s[2],h[2]) # s3 to h3
...
def simpleTest():
	...
	# net.pingAll()
	CLI(net)  #open the command line tool in terminal.
